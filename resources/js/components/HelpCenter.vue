                ...
                <div class="unicef-card">
                    <div class="card-body">
                        <div :key="video.id" v-for="(video,key) in videos">
                            ...
                            <div  class="row">
                            <div class="col-md-3" >
                                <img style="cursor:pointer" @click="openVideo(video)" width="100%" min-height="140px" :src="videoImage" alt="" srcset="">
                          ...
                          <p class="text-center" v-if="!showLoader && videos.length ==0">No Videos Yet!</p>
         ...
         <div class="modal" id="showVideo">
            <div class="modal-dialog modal-lg">
                <div v-if="selectedVideo" class="modal-content px-2 py-2">
                    ...
                    <!-- {{selectedVideo}} -->
                     <iframe :id="'vid_show_'+selectedVideo.id" autoplay="false" width="100%" height="400px" :src="selectedVideo.fullUrl" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
        ...
        mounted() {
            ...
            this.showLoader = true;
              app.authorize(this.platformUrl, (token) => {
                    axios({
                            method: "get",
                            url:this.platformUrl + "/api/get-help-videos?location=Web: PPM",
                                headers: {
