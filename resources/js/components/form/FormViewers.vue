...
<div class="w-100 py-3">
    <div class="row">
        <div class="col-md-9">
            <h3 style="font-weight: 500; color: #333; font-size: 1.575rem;">Viewers</h3>
        </div>
            ...
            <div class="col-md-8">
                <div class="form-card shadow-sm table-padding pt-0">
                    <div class="row">
                        <div class="col-md-12 border-bottom" style="padding: 0 !important;">
                            <nav class="nav nav-tab" id="unicef-tabs-form-users">
                                <a data-tab="0" @click.prevent="updateTab" href="#" style="color: #333; padding-left: 2.5rem !important; padding-right: 2.5rem !important; font-size: 16px;" class="nav-item nav-link active">Viewers</a>
                    ...
                    <div class="mt-4 mx-3" v-if="tab == 1">
                        <HorizontalBarGraph barType="view" :categoryHeight="50" :textSize="13" :data="assignments" class="mt-3" width="100%" barId="unicef-form-viewers-stats"></HorizontalBarGraph>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
export default {
    name: "FormViewers",
    props: ["user", "forms", "records", "users", "data", "assignments", "viewers"],
